...
This project is indexed by GitNexus as **company-os** (27616 symbols, 38787 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
