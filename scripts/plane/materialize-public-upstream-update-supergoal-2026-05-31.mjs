...
// One-off materializer for the 2026-05-31 Public-Upstream Update Channel
...
const EXTERNAL_PREFIX = "company-os-supergoal-public-upstream-update-2026-05-31";
const LABEL_MAP = `runtime/plane-label-map/${WORKSPACE}-${PROJECT_ID}.json`;
const BASE = "docs/templates/supergoals-2026-05-31";

const PRIORITY = {
  "public-upstream-update-parent": "high",
  "public-upstream-update-cli": "high",
  "public-upstream-update-promotion": "high",
  "public-upstream-update-private-consumer-smoke": "medium",
  "public-upstream-update-docs": "medium",
};

const CONTRACT_SET = [
  { slug: "public-upstream-update-parent", file: `${BASE}/public-upstream-update-parent.md` },
  { slug: "public-upstream-update-cli", parentSlug: "public-upstream-update-parent", file: `${BASE}/public-upstream-update-cli.md` },
  { slug: "public-upstream-update-promotion", parentSlug: "public-upstream-update-parent", file: `${BASE}/public-upstream-update-promotion.md` },
  { slug: "public-upstream-update-private-consumer-smoke", parentSlug: "public-upstream-update-parent", file: `${BASE}/public-upstream-update-private-consumer-smoke.md` },
  { slug: "public-upstream-update-docs", parentSlug: "public-upstream-update-parent", file: `${BASE}/public-upstream-update-docs.md` },
];
...
async function main() {
  ...
  const result = {
    version: "materialize-public-upstream-update-supergoal/2026-05-31",
    apply: args.apply,
...
main().catch((error) => {
  console.error(`materialize-public-upstream-update-supergoal failed: ${error.message}`);
  process.exitCode = 1;
});
