...
// One-off materializer for the 2026-06-03 Command EVE 0.8 remote-install RC
// supergoal. Dry-run by default; --apply creates/updates Plane work items via
// the Company.OS Plane App auth bridge.
...
const EXTERNAL_PREFIX = "company-os-supergoal-command-eve-080-rc-remote-install-2026-06-03";
const LABEL_MAP = `runtime/plane-label-map/${WORKSPACE}-${PROJECT_ID}.json`;
const BASE = "docs/templates/supergoals-2026-06-03";
const TARGET_DATE = "2026-06-04";

const PRIORITY = {
  "command-eve-080-rc-parent": "urgent",
  "command-eve-080-rc-release-baseline": "urgent",
  "command-eve-080-rc-install-update-cli": "urgent",
  "command-eve-080-rc-remote-onboarding-docs": "urgent",
  "command-eve-080-rc-clean-install-smoke": "high",
  "command-eve-080-rc-security-productization-gate": "urgent",
  "command-eve-080-rc-eve-first-run-check": "high",
  "command-eve-080-rc-remote-pilot-handoff": "high",
};

const CONTRACT_SET = [
  { slug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-parent.md` },
  { slug: "command-eve-080-rc-release-baseline", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-release-baseline.md` },
  { slug: "command-eve-080-rc-install-update-cli", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-install-update-cli.md` },
  { slug: "command-eve-080-rc-remote-onboarding-docs", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-remote-onboarding-docs.md` },
  { slug: "command-eve-080-rc-clean-install-smoke", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-clean-install-smoke.md` },
  { slug: "command-eve-080-rc-security-productization-gate", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-security-productization-gate.md` },
  { slug: "command-eve-080-rc-eve-first-run-check", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-eve-first-run-check.md` },
  { slug: "command-eve-080-rc-remote-pilot-handoff", parentSlug: "command-eve-080-rc-parent", file: `${BASE}/command-eve-080-rc-remote-pilot-handoff.md` },
];
...
async function main() {
  ...
  const result = {
    version: "materialize-remote-install-080-rc-supergoal/2026-06-03",
    apply: args.apply,
...
main().catch((error) => {
  console.error(`materialize-remote-install-080-rc-supergoal failed: ${error.message}`);
  process.exitCode = 1;
});
