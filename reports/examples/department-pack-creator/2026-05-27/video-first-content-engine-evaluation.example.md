# Department Capability Pack Evaluation - video-first-content-engine
...
- PASS capability_profile.declared: Worker contracts declare at least one CapabilityProfile.
- PASS capability_profile.present: Declared CapabilityProfiles are registered.
- PASS capability_profile.blocks_production: CapabilityProfiles block production writes.
- PASS capability_profile.blocks_public_publish: CapabilityProfiles block public publish.
- PASS capability_profile.blocks_secret_read: CapabilityProfiles block secret reads.
- PASS capability_profile.blocks_done: CapabilityProfiles block Plane Done by worker.
